...
<body>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled footer-menu lh-40 mb-0">
                            {{-- <li><a href="about.html"><i
                                        class="ti-angle-double-right mr-2"></i>{{ $config['footer'] }}</a>
                            </li> --}}
    ...
    <!--  Essential Scripts =====================================-->
    <!-- Main jQuery -->
    <script src="{{ asset('frontendend/plugins/jquery/jquery.js') }}"></script>
    <!-- Bootstrap 4.3.1 -->
    <script src="{{ asset('frontendend/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
    <!-- Slick Slider -->
    <script src="{{ asset('frontendend/plugins/slick-carousel/slick/slick.min.js') }}"></script>
    <!--  Magnific Popup-->
    <script src="{{ asset('frontendend/plugins/magnific-popup/dist/jquery.magnific-popup.min.js') }}"></script>
    <!-- Form Validator -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery.form/3.32/jquery.form.js"></script>
    <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.11.1/jquery.validate.min.js"></script>
    <!-- Google Map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script>
    <script src="{{ asset('frontendend/plugins/plugins/google-map/gmap.js') }}"></script>

    <script src="{{ asset('frontendend/js/script.js') }}"></script>
